const Loading = () => (
  <section className="flex flex-col h-full w-full">
    <div className="w-full h-16 flex items-center gap-x-7 max-w-[1140px] mx-auto lg:pt-[50px] pt-[20px] px-10">
    ...
    <div className="lg:h-[140px] h-[100px] border-t-2 mt-2 px-4 py-8 flex justify-end items-center max-w-[1140px] mx-auto w-full">
