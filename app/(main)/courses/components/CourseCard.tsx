...
export const CourseCard = ({
  ...
  <button
    ...
    className={cn(
      "h-full border-2 rounded-xl border-b-4 hover:bg-black/5 cursor-pointer active:border-b-2 focus-visible:border-b-2 outline-none flex flex-col items-center justify-between p-3 pb-6 w-full min-h-[150px] lg:min-h-[217px] lg:min-w-[200px]",
